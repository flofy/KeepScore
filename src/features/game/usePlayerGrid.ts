...
export function getPlayerGridColumns(layout: PlayerGridLayout, playerCount: number): number {
...
export function usePlayerGrid() {
  const [layout, setLayoutState] = useState<PlayerGridLayout>(getInitialPlayerGridLayout);
