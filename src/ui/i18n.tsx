...
orPlayer: 'Color for player',
 ...
 selecting!',
  ...
  fr: {
    ...
    startingScore: 'Score de depart', startingScoreHint: 'Defaut : 0',
    presets: 'PREREGLAGES', presetCustom: 'Personnalise',
    ...
    undo: 'Annuler', redo: 'Retablir', savedGames: 'Parties sauvegardees', history: 'Historique', moves: 'coups',
    noMoves: 'Aucun mouvement pour le moment.', movesPlaceholder: 'Les changements de score apparaitront ici.',
    edit: 'Modifier', delete: 'Supprimer', save: 'Valider', cancel: 'Annuler', newDelta: 'Nouveau delta de score', customDelta: 'Personnalise',
    addPoint: 'Ajouter un point a', removePoint: 'Retirer un point a', quickScoreChange: 'Changement rapide pour',
    flipPlayer: 'Retourner la carte du joueur',
    resume: 'Reprendre', untitledGame: 'Partie sans nom', noSavedGames: 'Aucune partie sauvegardee.',
    ...
    removeHistoryEntry: 'Supprimer cette entree', editHistoryD
